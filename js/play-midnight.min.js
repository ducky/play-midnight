...
})}),ot.each({Height:"height",Width:"width"},function(e,t){ot.each({padding:"inner"+e,content:t,"":"outer"+e},function(n,r){ot.fn[r]=function(r,i){var o=arguments.length&&(n||"boolean"!=typeof r),a=n||(r===!0||i===!0?"margin":"border");return jt(this,function(t,n,r){var i;return ot.isWindow(t)?t.document.documentElement["client"+e]:9===t.nodeType?(i=t.documentElement,Math.max(t.body["scroll"+e],i["scroll"+e],t.body["offset"+e],i["offset"+e],i["client"+e])):void 0===r?ot.css(t,n,a):ot.style(t,n,r,a)},t,o?r:void 0,o,null)}})}),ot.fn.size=function(){return this.length},ot.fn.andSelf=ot.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return ot});var ar=e.jQuery,sr=e.$;return ot.noConflict=function(t){return e.$===ot&&(e.$=sr),t&&e.jQuery===ot&&(e.jQuery=ar),ot},typeof t===Nt&&(e.jQuery=e.$=ot),ot}),function(e){var t={defaults:{favicon:!0,styled:!0,recentActivity:!0,theme:"default"},load:function(e){var t=this;chrome.storage.sync.get(t.defaults,function(t){e(t)})},populate:function(t){var n=this,r=e("#play-midnight-options #favicon"),i=e("#play-midnight-options #styled"),o=e("#play-midnight-options #recentActivity"),a=e("#play-midnight-options #"+t.theme+".theme-color");t.favicon&&r.prop("checked",!0).closest(".option").addClass("selected"),t.styled&&i.prop("checked",!0).closest(".option").addClass("selected"),t.recentActivity&&o.prop("checked",!0).closest(".option").addClass("selected"),a.prop("checked",!0).closest(".option").addClass("selected"),e("#play-midnight-options #save").addClass(t.theme),e("#play-midnight-options .option").on("click",function(){n.doSelect(this)})},doSelect:function(t){var n=e(t),r=n.closest(".options-group");r.find(".selected").removeClass("selected"),n.addClass("selected")},save:function(t){var n=e("#play-midnight-options #favicon").is(":checked"),r=e("#play-midnight-options #styled").is(":checked"),i=e("#play-midnight-options #recentActivity").is(":checked"),o=e("#play-midnight-options .theme-color:checked").attr("id"),a=e("#play-midnight-options #status");chrome.storage.sync.set({favicon:n,styled:r,recentActivity:i,theme:o},function(){a.fadeIn(500,function(){setTimeout(function(){a.fadeOut(500,function(){t()})},800)})})}},n={options:{},init:function(){var n=this;t.load(function(r){n.options=r,n.injectStyle(),n.updateFavicon(),n.injectOptions(function(){t.populate(n.options),e("#play-midnight-options #save").on("click",function(e){e.preventDefault(),t.save(function(){location.reload(!0)})}),e("#play-midnight-options #cancel").on("click",function(t){t.preventDefault(),e("#play-midnight-options").removeClass("show")})}),n.options.recentActivity===!0&&n.addSortOptions()}),this.addCredits()},injectStyle:function(){var t=null;if(this.options.styled===!0){var n=this.options.theme;t=e("<link>",{rel:"stylesheet",type:"text/css",href:chrome.extension.getURL("css/play-midnight-"+n+".css")}),e("head").append(t)}else t=e("<link>",{rel:"stylesheet",type:"text/css",href:chrome.extension.getURL("css/play-midnight-options.css")}),e("head").append(t)},injectOptions:function(t){var n=e("<div />",{id:"play-midnight-options"});e.get(chrome.extension.getURL("assets/options.html"),function(r){n.html(r),e("body").append(n);var i=e("<button />",{id:"btn-pm-options","class":"button small vertical-align"}).append(e("<img />",{src:chrome.extension.getURL("icon48.png")})).append("<span>Play Midnight Options</span>");i.on("click",function(){e("#play-midnight-options").addClass("show")}),e("#headerBar .nav-bar").prepend(i),t()})},updateFavicon:function(){this.options.favicon===!0&&e(window).load(function(){var t=chrome.extension.getURL("images/favicon.ico")+"?v="+Date.now();e('link[rel="SHORTCUT ICON"], link[href="favicon.ico"]').remove(),e("head").append(e("<link>",{rel:"shortcut icon",href:t}))})},addCredits:function(){var t="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=KHH9ZJH42FF4J",n="http://christieman.com/",r=e("<div",{"class":"nav-section-divider"}),i=e("<div>",{"class":"nav-section-header",text:"PLAY MIDNIGHT - "}).append(e("<a>",{href:t,text:"DONATE"})),o=e("<ul>",{id:"play-midnight"}).append(e("<li>",{"class":"nav-item-container"}).append(e("<a>",{href:n,text:"By Chris Tieman"})));e("#playMidnight-credits").length||e("#nav").append(e("<div>",{id:"playMidnight-credits"}).append(r).append(i).append(o))},addSortOptions:function(){function t(){e(this).children(".tab-text:contains(Recent)").length&&!e(this).children("#recent-sort").length?e(this).append(n):e("#recent-sort").remove(),e(this).one("DOMSubtreeModified",t)}var n=['<div id="recent-sort" class="tab-container">',' <a class="header-tab-title selected" data-reason="0">All</a>',' <a class="header-tab-title" data-reason="2">Added</a>',' <a class="header-tab-title" data-reason="3">Played</a>',' <a class="header-tab-title" data-reason="5">Created</a>',"</div>"].join("");e('<a data-type="recent" class="nav-item-container tooltip" href="">Recent Activity</a>').insertAfter("#nav_collections a:nth-child(2)"),e("#breadcrumbs").one("DOMSubtreeModified",t),e("#breadcrumbs").on("click","a",function(){var t=e(this),n=parseInt(t.data("reason")),r=0===n?"*":"[data-reason="+n+"]",i=e("#music-content .card");t.addClass("selected").siblings().removeClass("selected"),i.filter(r).show(),i.not(r).hide()})}};n.init()}(jQuery);