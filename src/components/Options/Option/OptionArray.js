...
class Option extends PureComponent {
  ...
  render() {
    ...
    const renderItems = items =>
      items.map(({ id: colorId, name, value: colorValue }, i) => (
        <CollectionItem
          ...
          theme={theme}
        >
          <input name={id} value={colorId} defaultChecked={value === colorId} onClick={onTargetedChange} type="radio" />
          ...
          <div
            ...
            onClick={e => this.removeColor(e, { id: colorId, name, color: colorValue })}
          >
